...
const GetUsedDataByDateInput = ({navigation}) => {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          <View
            ...
            <Text style={styles.headerText}>Lượng sử dụng theo ngày</Text>
          </View>
        </View>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              axios
                .get('http://222.252.14.147:6060/api/GetUsedDataByDate', {
                  params: {
                ...
                .then(function (response) {
                  if (
                    ...
                    navigation.navigate('GetUsedDataByDate', response.data);
                  }
                })
...
export default GetUsedDataByDateInput;
