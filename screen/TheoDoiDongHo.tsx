...
const TheoDoiDongHo = ({navigation}) => {
  ...
  return (
    ...
    <ImageBackground source={require('../image/bg.jpg')} style={styles.imageBg}>
      ...
      <View
        ...
        <Image style={styles.image} source={require('../image/Deatails.png')} />
      </View>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            axios
              .get('http://222.252.14.147:6060/api/GetEventByDate', {
                params: {
              ...
              .then(function (response) {
                ...
                if (
                  ...
                  navigation.navigate('GetEventByDate', response.data);
                  store.setState(state => {
                    state.getEventByDate = response.data;
                    return {...state};
                  });
                }
              })
